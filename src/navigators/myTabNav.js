    ...
    return (
      <Tab.Navigator screenOptions={{
        ...
        <Tab.Screen name="notificationstab" component={NotificationsScreen} options={{
          ...
          tabBarLabel: () => enableLabel ? <Text style={styles.tabBarLabel}>Notifications</Text> : ''
        }} />
        <Tab.Screen name="userstab" component={UsersScreen} options={{
          tabBarIcon: ({ focused }) => (
            <FontAwesome name="user-circle" size={20} color={focused ? 'blue' : '#000000'} />
          ),
          tabBarLabel: () => enableLabel ? <Text style={styles.tabBarLabel}>Users</Text> : ''
        }} />
        <Tab.Screen name="otherstab" component={MyDrawerNav} options={{
          tabBarIcon: ({ focused }) => (
            <FontAwesome name="question-circle" size={20} color={focused ? 'blue' : '#000000'} />
          ),
          tabBarLabel: () => enableLabel ? <Text style={styles.tabBarLabel}>Others</Text> : ''
        }} />
      </Tab.Navigator>
    );
}
